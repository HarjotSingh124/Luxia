        ...
        <div className="flex items-center gap-4">
          ...
          <div className="md:hidden">
            <button 
              ...
              aria-expanded={open} 
              className="p-2 text-yellow-200 border border-transparent rounded hover:border-yellow-600 transition   "
            >
      ...
      {open && (
        <div className="md:hidden bg-[rgba(0,0,0,0.9)]">
          <div className="px-6 py-4 flex flex-col gap-3">
            <Link href="/" className="block hover:text-gold transition text-yellow-300">Home</Link>
            <Link href="/shop" className="block hover:text-gold transition text-yellow-300">Shop</Link>
            <Link href="/about" className="block hover:text-gold transition text-yellow-300">About</Link>
            <Link href="/contact" className="block hover:text-gold transition text-yellow-300">Contact</Link>
          </div>
        </div>
      )}
    </header>
